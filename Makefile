...
CXX_FLAGS = -std=$(CXX_STD) -g -ggdb3 -fno-rtti -fno-exceptions -fverbose-asm -Wa,-ahlms=$(OUT_DIR_F)$(notdir $(<:.$(CXX_EXT)=.lst)) -fuse-cxa-atexit
...
isp: all
	./lpc21isp -control -bin $(BIN) /dev/ttyUSB0 115200 18432
